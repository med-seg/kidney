...
if 1:
    ...
    for s in range(len(subjectNamesNormal)):
        ...
        pickle.dump(Data4Ddpcs, open("/fileserver/abd/marzieh/preprocessedData_ha/singleSubjectsV4pc_detect/"+patientName+".p", "wb" ))
        pickle.dump(Data4D, open("/fileserver/abd/marzieh/preprocessedData_ha/singleSubjectsV4_detect/"+patientName+".p", "wb" ))
